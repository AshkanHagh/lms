...
CREATE INDEX IF NOT EXISTS "student_role_index" ON "users" USING btree ("role");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "student_id_index_subscription" ON "subscriptions" USING btree ("user_id");