...
export const subscriptionTable = pgTable(
  ...
  (table) => ({
    studentIdIndex: index("student_id_index_subscription").on(table.studentId),
  }),
);

export const purchaseCoursesTable = pgTable(
  "purchase",
  {
    id: uuid("id").primaryKey().defaultRandom(),
...
export const purchaseCoursesTableRelations = relations(
