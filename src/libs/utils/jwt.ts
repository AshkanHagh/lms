...
import type { TCookieOptions, TokenResponse, TSelectStudent } from '../../types/index.type';
...
export const sendToken = async <T extends 'refresh' | 'login'>(student : TSelectStudent, res : Response, tokenFor : T) : Promise<TokenResponse<T>> => {
...
export const decodeAccessToken = <T extends TSelectStudent | JwtPayload>(accessToken : string) : T => {
